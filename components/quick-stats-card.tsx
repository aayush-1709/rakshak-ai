...
export default function QuickStatsCard({ clusters }: QuickStatsCardProps) {
  ...
  const stats = [
    { label: 'Total Clusters', value: totalClusters, color: 'bg-slate-100' },
    { label: 'Critical', value: criticalCount, color: 'bg-red-100' },
    { label: 'Very High', value: veryHighCount, color: 'bg-orange-100' },
    { label: 'Avg Days Pending', value: avgSLA, color: 'bg-yellow-100' },
  ];
